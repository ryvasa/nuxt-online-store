<template>
  ...
  >
    <h1 class="text-3xl font-bold pl-8 pt-6 pb-4 text-primary">Sign In</h1>
    <div class="py-8 flex flex-col gap-3 w-full justify-center items-center">
      <form
      ...
      >
        ...
        <button class="py-2 w-full mt-4 btn btn-primary">Sign In</button>
        <div class="text-sm flex gap-1 py-8">
          <p>Don't have an account yet?</p>
          <nuxt-link to="/signup">
            <button class="text-primary font-semibold text-sm">Sign Up</button>
          </nuxt-link>
          <p>here</p>
        </div>
      </form>
      <div class="relative flex items-center">
        <div class="w-40 flex-grow border-t border-gray-700 border-2"></div>
